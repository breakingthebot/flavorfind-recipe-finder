...
- **Components (`src/components/`)**: Atomic, reusable React components:
  ...
  - `CookModeModal`: Fullscreen step-by-step cooking guide with step countdown timers, Web Audio beep chimes (sine chime, double beep, frequency sweep), hands-free voice commands matching custom mapping, a setting configurations tab, and an interactive conversions/substitutions advisor.
...
- 100% test coverage on the utility, model, and service layers (76 total unit tests).
