...
// Renders a sidebar drawer of favorite recipes, allowing quick removal and scroll-to-view navigation.
 ...
 */
export default function FavoritesList({ recipes, favorites, onToggleFav, isOpen, onClose }) {
